...
Public Class FrmCiudadesEditar
    ...
    Private Sub FrmCiudadesEditar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cargardatos()
    End Sub
    ...
    Private Sub BtnGuardarNuevo_Click(sender As Object, e As EventArgs) Handles BtnGuardarNuevo.Click
        Dim sql As String = "UPDATE `biblioteca`.`ciudad` SET `nombre_ciudad` = '" & TxtCiudad.Text & "' WHERE (`id_ciudad` = '" & misfunciones.getId & "');"
